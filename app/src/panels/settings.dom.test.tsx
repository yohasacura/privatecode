...
describe('the dialog', () => {
  it('is a modal with nine sections in a vertical tab list, opening on the one asked for', () => {
    draw('appearance')
    ...
    expect([...list.querySelectorAll('[role="tab"]')].map((t) => t.textContent?.trim()))
      .toEqual(['Server', 'Appearance', 'Permissions', 'Git', 'Skills', 'Plugins', 'MCP servers', 'Data', 'About'])
